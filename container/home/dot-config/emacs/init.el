...
(custom-set-variables
 ...
 '(package-selected-packages
   '(gruvbox-theme which-key web-mode vertico undo-fu-session smartparens rainbow-delimiters orderless nix-ts-mode nerd-icons marginalia lsp-ui lsp-mode heex-ts-mode forge evil-surround evil-matchit evil-indent-plus evil-goggles evil-commentary evil-collection evil-cleverparens embark-consult elixir-ts-mode corfu centered-cursor-mode envrc general)))
(custom-set-faces
