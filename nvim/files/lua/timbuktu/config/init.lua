...
setup("conform", {opt = {formatters_by_ft = {fennel = {"fnlfmt"}, _ = {"trim_whitespace"}}, format_after_save = {async = true, lsp_format = "fallback", timeout_ms = 5000}, notify_no_formatters = false}})
