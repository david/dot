...
local function define_handler_group(name)
  _G.assert((nil ~= name), "Missing argument name on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:3")
  handlers[name] = {}
  return nil
end
...
local function define_handler(group, handler_name, config)
  _G.assert((nil ~= config), "Missing argument config on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:9")
  _G.assert((nil ~= handler_name), "Missing argument handler-name on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:9")
  _G.assert((nil ~= group), "Missing argument group on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:9")
...
local function call_handlers(group_name, ...)
  local rest = {...}
  _G.assert((nil ~= rest), "Missing argument rest on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:14")
  _G.assert((nil ~= group_name), "Missing argument group-name on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:14")
...
local function _14_(_13_, plugin)
  ...
  _G.assert((nil ~= plugin), "Missing argument plugin on /var/home/david/Worktrees/dot/nvim/files/fnl/timbuktu/config/dsl.fnl:60")
