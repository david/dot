...
vim.keymap.set("n", "<D-.>", "<cmd>BufferLineCycleNext<cr>", { desc = "Switch to tab on the right" })
vim.keymap.set("i", "<D-.>", "<cmd>BufferLineCycleNext<cr>", { desc = "Switch to tab on the right" })
