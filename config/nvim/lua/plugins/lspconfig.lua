...
return setup("neovim/nvim-lspconfig", {config = _1_, dependencies = {kv("mason-org/mason.nvim", {opts = {}}), kv("mason-org/mason-lspconfig.nvim", {opts = {ensure_installed = {"biome", "lua_ls", "ruby_lsp", "tailwindcss", "ts_ls"}}}), kv("WhoIsSethDaniel/mason-tool-installer.nvim", {opts = {ensure_installed = {"erb-formatter", "stylua"}}}), kv("j-hui/fidget.nvim", {opts = {}}), "saghen/blink.cmp"}})
